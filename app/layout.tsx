...
export const metadata: Metadata = {
  title: "SparkLend Terminal — Datum Labs",
  description: "Real-time SparkLend protocol analytics by Datum Labs",
}
...
(function() {
  try {
    var stored = localStorage.getItem('sparklend-theme');
          ...
          >
            ...
            >
              <div className="flex items-center gap-1.5">
                ...
                <span>datumlabs.xyz/sparklend</span>
              </div>
