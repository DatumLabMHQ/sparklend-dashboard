...
Known reconciliation vs Blockworks:
  • Sparklend runs high because our Reserve Factor calc includes USDS/DAI reserves; Blockworks excludes them. Rewrite queued.
...
export function RevenueChart({ daily }: RevenueChartProps) {
  ...
  return (
    <ChartFrame
      ...
      footnote={
        <span>
          Series match Blockworks Research's Spark Total Revenue chart. Distribution Rewards now
          use flat-rate accrual (fixed today); Sparklend still runs a bit high because our reserve
          factor calc includes USDS/DAI that Blockworks strips (queued). The last bar covers the
