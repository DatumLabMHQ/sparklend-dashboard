...
Spark Liquidity Layer (SLL): Yield generated by the ALM Proxy (0x1601843c5E9bC251A3272907010AFa41Fa18347E) deploying idle USDS/DAI into ~19 strategies across Aave V3 Core/Prime, Morpho vaults (Spark USDC/DAI/USDS/USDT), Ethena sUSDe, Fluid sUSDS, Maple Syrup, BlackRock BUIDL, Centrifuge, Superstate, Curve pools and Sky sUSDS. Net of Sky Base Rate + sUSDS DSR funding costs, plus Morpho vault performance fees paid to SPARK_PROXY.\n\nComputed as DefiLlama dailyFees (gross yield across all SLL strategies) × Blockworks-anchored spread ratio (17.6% net-to-gross, calibrated to their July 2026 datapoint of $965K net on $5.49M gross). This approximates Blockworks' per-strategy on-chain method with a snapshot ratio applied uniformly; the exact spread varies day-to-day with strategy mix.
...
Known reconciliation vs Blockworks:
  ...
  • SLL: FIXED (v1). Switched from DefiLlama's dailyRevenue (which oversubtracts Sky Base Rate on the residual ALM Proxy float and flips negative) to DefiLlama's dailyFees scaled by Blockworks' effective spread ratio. Anchored to their July 2026 datapoint. Per-strategy on-chain read for exact daily spread is queued as v2.`
